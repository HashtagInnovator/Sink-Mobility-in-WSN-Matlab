...
[STATISTICS1,FD1,TD1,AD1]=Proposed_algo(IniEng,NetSize,NoOfNode,NoOfRound,cluster_head_percentage);%% Leach
...
legend('PROPOSED','LEACH-C','TS-I-LEACH','Location','SouthEast');
xlabel('x(time)');
